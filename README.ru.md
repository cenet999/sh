<br><br><br>
<div align="center">
<img src="docs/images/kejilionsh_logo.webp" alt="логотип" width="650">
</div>
...
```bash
bash <(curl -fsSL https://raw.githubusercontent.com/cenet999/sh/main/ru/kejilion.sh)
```
<br><br>

## 🖼️ Предпросмотр интерфейса
<img src="docs/images/kejilionsh_ru.webp" alt="Предпросмотр русской версии" width="75%"/>
...
## ⭐ Звездные тренды
[![Таблица истории звезд](https://api.star-history.com/svg?repos=cenet999/sh&type=Date)](https://star-history.com/#cenet999/sh&Date)

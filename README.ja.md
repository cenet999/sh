...
## 🚀 ワンクリックインストール
```bash
bash <(curl -fsSL https://raw.githubusercontent.com/cenet999/sh/main/jp/kejilion.sh)
```

***
## 🖼️ 実際のスクリーンショット

<img src="docs/images/kejilionsh_jp.webp" alt="日本語版プレビュー" width="75%"/>
...
## スターの歴史
[![星の歴史チャート](https://api.star-history.com/svg?repos=cenet999/sh&type=Date)](https://star-history.com/#cenet999/sh&Date)

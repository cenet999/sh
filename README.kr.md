...
## 🚀 원클릭 설치
```bash
bash <(curl -fsSL https://raw.githubusercontent.com/cenet999/sh/main/kr/kejilion.sh)
```
***

## 🖼️ 실제 화면 미리보기 (Preview)

<img src="docs/images/kejilionsh_kr.webp" alt="한국어 버전 미리보기" width="75%"/>
...
## 스타 역사
[![별 역사 차트](https://api.star-history.com/svg?repos=cenet999/sh&type=Date)](https://star-history.com/#cenet999/sh&Date)

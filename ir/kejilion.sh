...
UserLicenseAgreement() {
	...
	echo "توافق نامه مجوز کاربر: https://github.com/cenet999/sh/blob/main/LICENSE"
	echo -e "----------------------"
...
echo -e "${gl_kjlan}وبلاگ:${gl_bai}https://github.com/cenet999/sh          ${gl_kjlan}مرکز نرم افزار:${gl_bai}https://github.com/cenet999/sh${gl_bai}"
echo "------------------------"
echo ""
}
...
while true; do
	...
	echo "------------------------"
	echo "همه گزارش ها:${gh_proxy}raw.githubusercontent.com/cenet999/sh/main/kejilion_sh_log.txt"
	echo "------------------------"
